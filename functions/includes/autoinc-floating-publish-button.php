...
function fpb_enqueue_scripts() {
    ...
    if ( get_user_meta( get_current_user_id(), 'floating_publish_button', true ) !== '0' ) {
        wp_register_script( 'floating-publish-button-hstick', get_template_directory_uri() . '/assets/scripts/hcsticky.js', array( 'jquery' ), 1.0 );
        wp_register_script( 'floating-publish-button', get_template_directory_uri() . '/assets/scripts/floating-publish-button.js', array( 'jquery' ), 1.0 );
