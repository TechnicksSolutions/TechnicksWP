...
class BeRocket_AAPF_get_terms {
    ...
    public static function hierarchical_sort($terms, $args = array(), $additional = array()) {
        ...
        if(count($array_sort)==count($terms)) {array_multisort($array_sort, SORT_ASC, SORT_NUMERIC, $terms);}
        else
        {
        	/*error_log('var_dump($array_sort)======================');
	        error_log(print_r($array_sort,true));
	        error_log('var_dump($terms)======================');
